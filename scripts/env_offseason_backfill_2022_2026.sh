...
export OFFSEASON_SERVING_BUNDLE="data/processed/offseason/backfill_2022_2026"
export OFFSEASON_REQUIRED_SEASONS="2022,2023,2024,2025,2026"
...
export HIERARCHICAL_EFFECTS_PATH="models/artifacts/offseason/backfill_2022_2026/hierarchical_effects.csv"
export BASELINE_COEFFICIENTS_PATH="models/artifacts/offseason/backfill_2022_2026/baseline_coefficients.csv"